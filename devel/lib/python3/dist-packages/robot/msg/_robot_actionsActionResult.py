...
"""autogenerated by genpy from robot/robot_actionsActionResult.msg. Do not edit."""
import codecs
import sys
...
class robot_actionsActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "robot/robot_actionsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot/robot_actionsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(robot_actionsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot.msg.robot_actionsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot.msg.robot_actionsResult()
